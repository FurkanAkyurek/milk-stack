    ...
    private void OnSceneGUI()
    {
        ...
        else
        {
            ...
            if (_spline.Theme.showShortcutMenu)
            {
                ...
                {
                    GUI.Box(new Rect(10, SceneView.lastActiveSceneView.camera.pixelHeight - 60, 350, 50), string.Format("Shift [Hold]:{0}Shift + Right Click:{0}Ctrl + Left Click:", System.Environment.NewLine), shortCutmenuStyle);
                    GUI.Label(new Rect(95, SceneView.lastActiveSceneView.camera.pixelHeight - 55, 210, 30), "Preview new curve");
                    GUI.Label(new Rect(135, SceneView.lastActiveSceneView.camera.pixelHeight - 42, 210, 30), "Add new curve");
                    GUI.Label(new Rect(120, SceneView.lastActiveSceneView.camera.pixelHeight - 29, 210, 30), "Control points multi-selection");
                }
            }
        }
