...
namespace WSMGameStudio.Splines
{
    public class LinkedSplineFollower : MonoBehaviour
    {
        ...
        /// </summary>
        public void FollowMaster(int followOffset)
        {
            ...
            _currentPointIndex = _master.CurrentPointIndex - followOffset;
            ...
            else
            {
                ...
                _transform.position = Vector3.Lerp(_startPosition, _endPosition, _master.SegmentProgress);
                _transform.rotation = Quaternion.Slerp(_startRotation, _endRotation, _master.SegmentProgress);
            }
        }

        private void CalculateOverflownPosition(int followOffset)
        {
        ...
        /// </summary>
        public void MoveToStartPosition(int followOffset)
        {
